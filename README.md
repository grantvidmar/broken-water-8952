...
[![Deploy to Cloudflare](https://deploy.workers.cloudflare.com/button)](https://deploy.workers.cloudflare.com/?url=https://github.com/cloudflare/templates/tree/main/broken-water-8952)
...
```
npm create cloudflare@latest -- --template=cloudflare/templates/broken-water-8952
```

A live public deployment of this template is available at [https://broken-water-8952.templates.workers.dev](https://broken-water-8952.templates.workers.dev)
